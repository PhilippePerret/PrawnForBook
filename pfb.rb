...
begin
  # Dossier du livre (dans lequel la commande a été lancée)
  # Note : il faut le prendre avant de requérir les librairies
  # car clir analyse tout de suite la ligne de commande.
  BOOK_DIR = BOOK_FOLDER = ARGV.shift
