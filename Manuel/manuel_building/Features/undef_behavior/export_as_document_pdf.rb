Prawn4book::Manual::Feature.new do 
  ...
  description <<~EOT
    Bien que _PFB_ soit principalement pensé et conçu pour produire un PDF pour l'imprimerie, on peut également s'en servir pour produire un fichier PDF numérique (comme ce manuel par exemple).
