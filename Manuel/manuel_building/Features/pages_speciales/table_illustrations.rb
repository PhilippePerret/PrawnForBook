Prawn4book::Manual::Feature.new do
  ...
  description <<~EOT
    ...
    #### Affichage de la table des illstrations

    Pour afficher cette table, qu’on placera en général juste après la [[pages_speciales/table_des_matieres]] en début de livre, on utilise simplement une des marques suivantes :
  ...
  texte(:as_sample, "… alors le livre contiendra :")
