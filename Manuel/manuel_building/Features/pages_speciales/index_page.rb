Prawn4book::Manual::Feature.new do
  ...
  description <<~EOT
    Si l’on peut faire autant d’index que l’on désire avec _PFB_ (cf. ???), il n’en reste pas moins qu’il existe une page d’index à proprement parler, comme il en existe dans de nombreux livres. 
