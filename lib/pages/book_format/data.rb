...
class BookFormat
  ...
  PAGE_DATA = {
    ...
    page: {
      ...
      pagination_format:            {name:'Format de la numérotation'         , default:'first-last', values: :values_format_numerotation},
      no_num_if_empty:             {name:'Pas de numéro sur pages vides'     , default: true   , type: :bool},
    ...
    text: {
      default_font:             {name:'Fonte/style/taille/couleur par défaut'            , default: nil, values: Prawn4book::Fonte.method(:as_choices)},
