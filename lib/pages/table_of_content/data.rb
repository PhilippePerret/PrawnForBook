...
class TableOfContent < SpecialPage
  ...
  PAGE_DATA = {
    ...
    level1: {
      font:         {name:'Fonte-string titre niveau 1', default: 'Times-Roman/normal/12/0000000', values: Fonte.method(:as_choices)},
    ...
    level2: {
      font:         {name:'Fonte-string titre niveau 2', default: 'Times-Roman/normal/10/0000000', values: Fonte.method(:as_choices)},
      numero_size:  {name:'Taille pour le numéro', default: 10},
    ...
    level3: {
      font:         {name:'Fonte-string titre niveau 3', default: 'Times-Roman/normal/9/0000000', values: Fonte.method(:as_choices)},
      numero_size:  {name:'Taille pour le numéro', default: 10},
    ...
    level4: {
      font:         {name:'Fonte-string titre niveau 3', default: 'Times-Roman/normal/8/0000000', values: Fonte.method(:as_choices)},
      numero_size:  {name:'Taille pour le numéro', default: 10},
