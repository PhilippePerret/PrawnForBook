...
class TableOfContent < SpecialPage
  ...
  PAGE_DATA = {
    ...
    level1: {
      font:         {name:'Police titre niveau 1', default: 'Times-Roman', values: :police_names},
      size:         {name:'Taille titre niveau 1', default: 12},
      style:        {name:'Style du titre niveau 1', default: nil},
    ...
    level2: {
      font:         {name:'Police titre niveau 2', default: 'Times-Roman', values: :police_names},
      size:         {name:'Taille titre niveau 2', default: 10},
      style:        {name:'Style du titre niveau 2', default: nil},
      numero_size:  {name:'Taille pour le numéro', default: 10},
    ...
    level3: {
      font:         {name:'Police titre niveau 3', default: 'Times-Roman', values: :police_names},
      size:         {name:'Taille titre niveau 3', default: 9},
      style:        {name:'Style du titre niveau 3', default: nil},
      numero_size:  {name:'Taille pour le numéro', default: 10},
    ...
    level4: {
      font:         {name:'Police titre niveau 4', default: 'Times-Roman', values: :police_names},
      size:         {name:'Taille titre niveau 4', default: 8},
      style:        {name:'Style du titre niveau 4', default: nil},
      numero_size:  {name:'Taille pour le numéro', default: 10},
